...
public class Epoch implements Serializable {
    ...
    private static final double MINUTES_PER_DEGREE = 60D;
    ...
    public final void setPosition(final Planet planet, final String position) {
    ...
    public final double getPreciseDegrees(final Planet planet) {
        return getDegrees(planet) + (((getMinutes(planet) * PRECISION) / MINUTES_PER_DEGREE) / PRECISION);
    }

    /**
     * Determines and returns the position of the south node by evaluating the
     * north node position.
     */
    private String determineSouthNodePosition() {
